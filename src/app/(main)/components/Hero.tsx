    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          >
            <div
              className="relative h-[30rem] w-[30rem] mx-auto"
              style={{
            ...
            >
              ...
              >
                <MotionCard className="h-full w-full flex items-center justify-center">
                  <motion.div
                ...
                <MotionCard className="h-full w-full flex items-center justify-center p-6 bg-slate-900/95">
                  <div className="relative w-full h-full flex flex-col items-center justify-center">
                    ...
                    <button
                      ...
                      className="absolute top-2 right-2 p-1.5 rounded-full bg-red-500/20 hover:bg-red-500/30 transition-all z-10"
