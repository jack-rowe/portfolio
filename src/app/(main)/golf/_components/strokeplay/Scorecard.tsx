...
export function Scorecard({
    ...
    const frontHoles = holes.slice(0, STROKEPLAY_FRONT_NINE);
    const backHoles = holes.slice(STROKEPLAY_FRONT_NINE);
            ...
            <div className="overflow-x-auto">
                <div className="inline-block min-w-full">
                    <div className="flex border-b border-border bg-card">
                        ...
                        {backHoles.map((_, h) => {
                            const idx = h + STROKEPLAY_FRONT_NINE;
                            return (
                                <HoleHeader
                                    key={`hd-b-${String(idx)}`}
                                    holeIdx={idx}
                    ...
                    {players.map((p, i) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                {backHoles.map((h, hi) => {
                                    const idx = hi + STROKEPLAY_FRONT_NINE;
                                    return (
                                        <HoleCell
