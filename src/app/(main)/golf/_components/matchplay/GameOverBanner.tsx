...
import { finalStandings } from "../../_lib/matchplay/engine";
import type { MatchplayPlayer } from "../../_lib/matchplay/types";
    ...
    return (
        ...
        >
            ...
            <p className="text-sm text-muted-foreground">
                {winner.points} hole{winner.points === 1 ? "" : "s"} won over{" "}
                {holesPlayed} played
            </p>
            <Button
                variant="outline"
