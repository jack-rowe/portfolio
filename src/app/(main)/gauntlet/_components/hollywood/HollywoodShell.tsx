    ...
    return (
        <div className="rounded-lg border border-border bg-card p-3 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
                {SEGMENTS.map((s, idx) => {
                    const aNames = s.teamA.map((i) => players[i].name).join("+");
                    const bNames = s.teamB.map((i) => players[i].name).join("+");
                    ...
                    return (
                        ...
                        >
                            ...
                            <p className="font-clash text-xs font-bold leading-tight truncate">
                                {aNames}
                            </p>
